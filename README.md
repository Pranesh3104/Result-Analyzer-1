...
Do you want the project name to be **“Result-Analyzer”** everywhere, or should the README title be **“Academic Performance Analyzer”** (like in `replit.md`)?

If you paste the `artifacts/exam-analyzer/package.json` too, I can fix the exact `pnpm --filter ...` run commands to match your package names.
